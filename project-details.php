...
<!--==================================================-->
<!-- Strat Toptech Project Details Area-->
<!--==================================================-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="project-details-thumb">
					<img src="assets/images/inner-images/project-details-thumb.jpg" alt="">
				</div>
			</div>
		</div>
		<div class="row">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="project-details-content">
							...
							<div class="row align-items-center">
								<div class="col-lg-6">
									<div class="project-details-item-images">
										<img src="assets/images/inner-images/project-details-item-images.jpg" alt="">
									</div>
								</div>
								<div class="col-lg-6">
									<div class="project-details-list-item">
										<h4>Project Benifits</h4>
										<ul>
							...
							<a class="project-details-text" href="#">Competently architect intermandated deliverables client niches continually underwhelm</a>
...
<!--==================================================-->
<!-- End Toptech Project Details Area-->
<!--==================================================-->



<!--==================================================-->
<!-- Strat Toptech Project Area -->
<!--==================================================-->
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="single-project-box">
					<div class="project-thumb">
						<img src="assets/images/inner-images/project-1.png" alt="">
					</div>
					<div class="project-content">
						...
						<div class="project-shape">
							<img src="assets/images/inner-images/project-shape.png" alt="">
						</div>
					</div>
				</div>
			</div>				
			<div class="col-lg-4 col-md-6">
				<div class="single-project-box">
					<div class="project-thumb">
						<img src="assets/images/inner-images/project-2.png" alt="">
					</div>
					<div class="project-content">
						<h4>Environment</h4>
			...
			<div class="col-lg-4 col-md-6">
				<div class="single-project-box">
					<div class="project-thumb">
						<img src="assets/images/inner-images/project-3.png" alt="">
					</div>
					<div class="project-content">
						<h4>Recycling</h4>
