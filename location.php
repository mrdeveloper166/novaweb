...
<!--==================================================-->
<!-- Start Toptech Location Area Inner Style-->
<!--==================================================-->
<div class="location-area inner-style">
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="single-location-box">
					<div class="location-thumb">
						<img src="assets/images/inner-images/flag-1.png" alt="">
					</div>
					<div class="location-content">
						<h4>Paraguay.</h4>
						<p>2307 Rd Brooklyn, New York 11226 USA</p>
						<div class="location-icon">
							<img src="assets/images/inner-images/location-icon.png" alt="">
						</div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="single-location-box">
					<div class="location-thumb">
						<img src="assets/images/inner-images/flag-2.png" alt="">
					</div>
					<div class="location-content">
						<h4>Bangladesh.</h4>
						<p>2307 Rd Brooklyn, New York 11226 USA</p>
			...
			<div class="col-lg-4 col-md-6">
				<div class="single-location-box">
					<div class="location-thumb">
						<img src="assets/images/inner-images/flag-3.png" alt="">
					</div>
					<div class="location-content">
						<h4>United States.</h4>
						<p>2307 Rd Brooklyn, New York 11226 USA</p>
...
<!--==================================================-->
<!-- End Toptech Location Area Inner Style -->
<!--==================================================-->
